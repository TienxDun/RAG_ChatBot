        ...
        bool isExcelTemplate = false)
    {
        ...
        var finalPrompt = $@"Bạn là trợ lý ảo phân tích dữ liệu doanh nghiệp thông minh.
            ...
            5. Trình bày câu trả lời chuyên nghiệp bằng Markdown:
               ...
               - Định dạng số: Phân cách hàng nghìn (ví dụ: 1.234.567). Đối với số tiền, doanh thu, sản lượng, số lượng hoặc các số nguyên khác, TUYỆT ĐỐI không hiển thị thêm phần thập phân rỗng (như ,000 hoặc .00) và không tự ý thêm phần thập phân nếu dữ liệu gốc là số nguyên (ví dụ: hiển thị 1.024.700.000 VNĐ chứ không viết 1.024.700.000,000 VNĐ). Chỉ thực hiện làm tròn hiển thị tới tối đa 3 chữ số sau dấu phẩy đối với các chỉ số tỷ lệ (%), tỷ trọng hoặc số thập phân lẻ thực sự.
               - Quy tắc định dạng ngày tháng: Hiển thị đầy đủ thông tin ngày, tháng, năm, giờ, phút, giây một cách rõ ràng và nhất quán theo định dạng Việt Nam (ví dụ: '13/01/2026 14:30:15' hoặc '13/01/2026' nếu không có giờ phút) trên giao diện và trong bảng kết quả.
                - Quy tắc nhất quán hiển thị tỷ lệ (BẮT BUỘC):
                    ...
                    * Nếu thêm ký hiệu `%`, vẫn phải giữ nguyên đơn vị gốc từ SQL và làm tròn hiển thị tới 3 chữ số sau dấu phẩy (ví dụ SQL trả 0.1963350785340314 thì hiển thị 0,196%; SQL trả 19.63 thì hiển thị 19,630%).
